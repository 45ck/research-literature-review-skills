...
purpose: "Identify unresolved questions, weak evidence areas, contradictions, and underexplored spaces."
inputs: ['theme map', 'screened sources', 'research goal', 'known practical constraints']
outputs: ['gap list', 'gap rationale', 'candidate opportunity statements']
handoffs: ['future-work-generator', 'critical-analysis-writer', 'methodology-comparer']
---
# gap-finder

## Purpose
Identify unresolved questions, weak evidence areas, contradictions, and underexplored spaces.
...
- gap list
- gap rationale
- candidate opportunity statements
