---
name: "search-string-designer"
pack: "research-literature-review-pack"
purpose: "Design search strings and source strategies for efficient, reproducible literature searches."
inputs: ['research question', 'keywords and synonyms', 'databases or sources', 'timeframe or discipline bounds']
outputs: ['search string set', 'source plan', 'inclusion and exclusion hints']
handoffs: ['paper-screening-checker', 'related-work-synthesizer', 'evidence-strength-scorer']
---
# search-string-designer

## Purpose
Design search strings and source strategies for efficient, reproducible literature searches.
...
- timeframe or discipline bounds

## Deliverables
- search string set
- source plan
- inclusion and exclusion hints
