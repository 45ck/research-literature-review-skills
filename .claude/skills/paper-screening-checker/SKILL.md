---
name: "paper-screening-checker"
pack: "research-literature-review-pack"
purpose: "Screen candidate sources against relevance, quality, and scope criteria."
inputs: ['research question', 'candidate paper list', 'screening criteria', 'exclusion reasons if used']
outputs: ['screened paper set', 'screening decisions', 'exclusion log']
handoffs: ['literature-theme-extractor', 'evidence-strength-scorer', 'critical-analysis-writer']
---
# paper-screening-checker

## Purpose
Screen candidate sources against relevance, quality, and scope criteria.
