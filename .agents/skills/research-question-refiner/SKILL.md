...
purpose: "Refine broad topics into focused, researchable questions with clear scope and variables."
inputs: ['topic or problem area', 'initial objective', 'constraints or domain', 'known context if any']
outputs: ['refined research question set', 'scope statement', 'assumptions and exclusions']
handoffs: ['search-string-designer', 'methodology-comparer', 'critical-analysis-writer']
---
# research-question-refiner

## Purpose
Refine broad topics into focused, researchable questions with clear scope and variables.
